...
export const zkCV = createSlice({
    ...
    reducers: {
        ...
        getChosenCVIsLoading: (state) => {
            state.getChosenCV.isLoading = true
            state.getChosenCV.isSuccess = false
            state.getChosenCV.isRejected = false
            state.getChosenCV.transactionHash = null
        },
        getChosenCVSuccess: (state, action) => {
            state.getChosenCV.isLoading = false
            state.getChosenCV.isSuccess = true
            state.getChosenCV.isRejected = false
            state.getChosenCV.transactionHash = action.payload.transactionHash
        },
        getChosenCVRejected: (state) => {
            state.getChosenCV.isLoading = false
            state.getChosenCV.isSuccess = false
            state.getChosenCV.isRejected = true
            state.getChosenCV.transactionHash = null
        },
    },
})
