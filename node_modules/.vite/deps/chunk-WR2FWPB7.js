...
var require_rpc2 = __commonJS({
  "node_modules/viem/_cjs/errors/rpc.js"(exports) {
    ...
    var ResourceUnavailableRpcError2 = class extends RpcError {
      constructor(cause) {
        super(cause, {
...
initProvider_fn = async function() {
  const { EthereumProvider, OPTIONAL_EVENTS, OPTIONAL_METHODS } = await import("./index.es-J36CLCL4.js");
...
var CoinbaseWalletConnector = class extends Connector {
  ...
  async getProvider() {
    if (!__privateGet(this, _provider2)) {
      let CoinbaseWalletSDK = (await import("./dist-WUJXJIFQ.js")).default;
...
var WalletConnectLegacyConnector = class extends Connector {
  ...
  async getProvider({
    ...
    if (!__privateGet(this, _provider3) || chainId || create) {
      ...
      const WalletConnectProvider = (await import("./esm-2ZGMN2QH.js")).default;
...
//# sourceMappingURL=chunk-WR2FWPB7.js.map
